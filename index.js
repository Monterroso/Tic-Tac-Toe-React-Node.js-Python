...
app.get("/", function(req, res) {
  let pyshell = new PythonShell(__dirname + "Python/python_controller.py");
  let gameResult;
  ...
  pyshell.end(function (err, code, signal) {
    ...
    gameInformation = {game: createJSON(gameResult), currentGame: currentGame, currentOptions: currentOptions}
